...
const atualizarCarrinho = () => {
	...
	if(cart.length > 0) {
		...
		// zerar .cart para nao fazer insercoes duplicadas
        ...
        if(subtotal > 120){
            seleciona('.cart--totalitem.desconto .vinte--desc').style.display = 'block'
            desconto = subtotal * 0.2
            seleciona('.cart--totalitem.desconto .quinze--desc').style.display = 'none'
        }else if(subtotal > 75 && subtotal < 119.99){
            seleciona('.cart--totalitem.desconto .quinze--desc').style.display = 'block'
            desconto = subtotal * 0.15
            seleciona('.cart--totalitem.desconto .vinte--desc').style.display = 'none'
        }else if(subtotal < 74.99){
            seleciona('.cart--totalitem.desconto .quinze--desc').style.display = 'none'
        }
